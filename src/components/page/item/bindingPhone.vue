<template>
  <div class="main">
    <v-head name="绑定手机号"></v-head>
    <div class="item-box">
      <div class="box">
        <input type="tel" v-model="phone" maxlength="11" placeholder="请输入需要绑定手机号"/>
      </div>
      <div class="box">
  ...
  export default {
    ...
    methods: {
      ...
      getCode:function(){
        ...
        this.$get('/api/v1/setList/SendCodes',data).then(response=>{
          that.pay_code_key = response.code
